...
//        print_r($state);
        ...
        if (1 === count($this->pickup_locations)) {
            ...
            $orange_combo_variations = array(24064, 24063, 24061, 24060, 24058, 24057, 31085, 31084, 24055, 30953, 24053, 24054);
            $orange_nano_variations =  array(24064, 24063, 24062, 24061, 24060, 24059, 24058, 24057, 24056, 31085, 31084, 31083, 24055, 30953, 30954, 24053, 24054, 30955);
                        ...
                        foreach (WC()->cart->get_cart() as $cart_item) {
                            ...
                            if ($product_id == 58961) {
                                ...
                                foreach( $cart_item['variation'] as $attribute_val ){
                                    ...
                                    if ($attribute_val == 'Стандарт' || $attribute_val == 'Micro-SIM'){
                                        if ($combo !== 0) $orange_validation++;
                                    }
                                    if ($attribute_val == 'Стандарт' || $attribute_val == 'Micro-SIM' || $attribute_val == 'Nano-SIM'){
                                ...
                                //СТАРАЯ!!! Проверка вариации товара на
	                        ...
	                        if ($product_id == 59130) {
		                        if (!in_array('globalsim--travelchat', $exist_operators)) continue 2;
	                        }
                            if ($product_id == 59135) {
	                        ...
	                        if ($product_id == 59140) {
		                        if (!in_array('three', $exist_operators)) continue 2;
	                        }
