 ...
 */
function wc_local_pickup_plus_get_product_availability( $product ) {
	return wc_local_pickup_plus()->get_products_instance()->get_local_pickup_product_availability( $product );
}
