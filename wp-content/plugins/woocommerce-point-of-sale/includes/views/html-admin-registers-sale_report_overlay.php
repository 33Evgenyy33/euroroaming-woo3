			...
			foreach ($results as $value) {
                ...
                <tr>
                    <td>
						...
						if ($the_order->user_id && !empty($user_info)) {
                    ...
                    <td><?php
						...
						if ($the_order->payment_method_title) {
							if (!isset($payment_methods[$the_order->payment_method_title]))
								...
								$payment_methods[$the_order->payment_method_title] += $the_order->get_total();
							if (!isset($payment_totals[$the_order->payment_method]))
								$payment_totals[$the_order->payment_method] = $the_order->get_total();
							else
								$payment_totals[$the_order->payment_method] += $the_order->get_total();
						}
						?>
