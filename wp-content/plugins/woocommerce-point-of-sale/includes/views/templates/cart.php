...
<!--			<a href="#" class="add_custom_meta button tips" data-tip="Edit Product"></a>-->
		...
		<td class="line_cost">
			<div class="view">
            {{#if editable}}
                <input type="text" class="product_price" placeholder="{{cart_item_data.price}}" value="{{cart_item_data.price}}" disabled data-discountsymbol="currency_symbol" data-percent="0" >
            {{else}}
				<input type="text" class="product_price" placeholder="{{cart_item_data.price}}" value="{{cart_item_data.price}}" disabled data-discountsymbol="currency_symbol" data-percent="0" disabled="disabled">
            {{/if}}
			</div>
		</td>
...
<script type="text/template" id="tmpl-cart-coupon-code">
    <tr data-coupon="{{coupon_code}}" class="tr_order_coupon order_coupon_{{coupon_code}}" style="display: none">
...
<script type="text/template" id="tmpl-cart-pos-discount">
    <tr data-coupon="POS Discount" class="tr_order_coupon order_coupon_pos_discount" style="display: none">
