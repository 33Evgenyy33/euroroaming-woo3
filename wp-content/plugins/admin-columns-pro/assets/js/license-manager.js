jQuery( function( $ ) {
	$( document ).ready( function() {
		$( '.ac-message [data-hide-notice=license-check]' ).click( function() {
...
if ( typeof cpac_license_check_js == 'undefined' ) {
	...
	jQuery( document ).ready( function( $ ) {
		$( 'body' ).on( 'click', '.cpac-check-license', function() {
			if ( !$( this ).hasClass( 'disabled' ) ) {
				...
				$( this ).after( '<div class="spinner ac-spinner inline"></div>' ).show();
