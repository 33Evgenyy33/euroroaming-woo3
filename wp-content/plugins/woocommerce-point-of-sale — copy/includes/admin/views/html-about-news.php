...
<div class="feature-section one-col">
	<p class="lead-description"><?php _e("WooCommerce Point of Sale 3.2 is another update which makes our already flexible and versatile Point of Sale plugin even more powerful. Cash float management, bill screen display, inline product discount, keyboard shortcuts and many more.", 'wc_point_of_sale'); ?></p>
</div>
<div class="feature-section two-col">
	<div class="col">
		<h3><?php _e( 'Cash Float Management', 'wc_point_of_sale' ); ?></h3>
		<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/about-images/cash-management.jpg" alt="Actuality Extensions" />
	...
	<div class="col">
		...
		<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/about-images/keyboard-shortcuts.jpg" alt="Actuality Extensions" />
...
<div class="feature-section two-col">
	<div class="col">
		...
		<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/about-images/multiple-receipts.jpg" alt="Actuality Extensions" />
	...
	<div class="col">
		...
		<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/about-images/bill-screen.jpg" alt="Actuality Extensions" />
...
<div class="feature-section two-col">
	...
	<div class="col">
		...
		<img id="ae-logo" src="<?php echo esc_url( WC_POS()->assets_url ); ?>images/about-images/switch-register.jpg" alt="Actuality Extensions" />
