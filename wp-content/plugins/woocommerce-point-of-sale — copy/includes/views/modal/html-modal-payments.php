    ...
    <div class="md-content">
                                    ...
                                    <table class="tendered_change_cod">
                                        <tr>
                                            <th class="amount_tendered">
                                                <label><?php _e('Tendered', 'wc_point_of_sale'); ?></label></th>
                                            <td class="amount_tendered"><input name="amount_pay" id="amount_pay_cod"
                                                                               type="text" class="txtpopamtfild"/></td>
                                        </tr>
                                        <tr>
                                            <th class="amount_change">
                                                <label><?php _e('Change', 'wc_point_of_sale'); ?></label></th>
                                            <td class="amount_change"><input name="amount_change" id="amount_change_cod"
        ...
        <?php if (!empty($available_gateways)) { ?>
            <div class="wrap-button">
                <input name="" type="button" class="button back_to_sale md-close"
                       value="<?php _e('Back', 'wc_point_of_sale'); ?>"/>
                <input name="" type="button" class="button-primary go_payment "
                       value="<?php _e('Pay', 'wc_point_of_sale'); ?>"/>
                <div id="payment_switch_wrap" style="display: none">
