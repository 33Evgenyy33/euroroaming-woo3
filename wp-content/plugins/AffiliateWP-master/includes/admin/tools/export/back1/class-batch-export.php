...
class Export extends \Affiliate_WP_Export {
	...
	public function __construct( $step ) {
		...
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/__construct_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/__construct_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
...
//		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/aff_wp_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
//		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/aff_wp_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
//
