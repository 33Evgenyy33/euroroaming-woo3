...
class Export_Referrals extends Batch\Export\CSV implements Batch\With_PreFetch {
	...
	public function init( $data = null ) {
		...
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/null_init_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/null_init_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );

		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/null_init.txt", print_r( $data, true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/null_init.txt", print_r( '=======================', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/null_init.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
		...
		if ( null !== $data ) {
			...
			file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/not_null_init_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
			file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/not_null_init_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );

			file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/not_null_init.txt", print_r( $data, true ), FILE_APPEND | LOCK_EX );
			file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/not_null_init.txt", print_r( '=======================', true ), FILE_APPEND | LOCK_EX );
			file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/not_null_init.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
		}
...
//		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/aff_wp.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
		...
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_data_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_data_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );

		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_data.txt", print_r( $args, true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_data.txt", print_r( '=======================', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_data.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
	...
	public function get_stat_affil() {
		...
		$test11 = $this->get_data();

		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_stat_affil_count.txt", print_r( '1', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_stat_affil_count.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );

		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_stat_affil.txt", print_r( $test11, true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_stat_affil.txt", print_r( '=======================', true ), FILE_APPEND | LOCK_EX );
		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/get_stat_affil.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
		...
		array_push( $all_date, $data1 );

//		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/aff_wp.txt", print_r( $all_date, true ), FILE_APPEND | LOCK_EX );
//		file_put_contents( $_SERVER['DOCUMENT_ROOT'] . "/logs/aff_wp.txt", print_r( "\n", true ), FILE_APPEND | LOCK_EX );
