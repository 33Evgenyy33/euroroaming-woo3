	...
	public function init_form_fields() {
		...
		self::$register_detail_fields = array(
				...
				'default_customer' => array(
					...
					'type'        => 'select',
					'options'     => array( __( 'Гость', 'wc_point_of_sale' )),
    	...
    	<form method="get" action="" class="search-form">
			<p class="search-box">
				...
				if (current_user_can('manage_wc_point_of_sale') ) {
					echo '<input type="search" value="" name="s" id="register-search-input">';
					echo '<input type="submit" value="Поиск партнера" class="button" id="search-submit" name="">';
				}
					?>
