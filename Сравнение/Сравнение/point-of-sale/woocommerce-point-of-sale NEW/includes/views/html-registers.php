...
<div class="wrap" id="wc-pos-registers-edit">
    <h2>
        <?php echo $data['name']; ?>
        <a class="button tips" href="<?php echo $admin_url; ?>admin.php?page=wc_pos_registers" id="go_back_register"
           data-tip="<?php _e('Return To Registers', 'wc_point_of_sale'); ?>"><?php _e('Back', 'wc_point_of_sale'); ?></a>
        ...
        <?php if (current_user_can('edit_private_shop_orders')) { ?>
            <a class="button tips" href="<?php echo $admin_url; ?>edit.php?post_type=shop_order" id="orders_page"
               data-tip="<?php _e('Orders', 'wc_point_of_sale'); ?>"><?php _e('Orders', 'wc_point_of_sale'); ?></a>
        <?php } ?>
        <?php if (current_user_can('manage_wc_point_of_sale')) { ?>
            <a class="button tips" href="<?php echo $admin_url; ?>admin.php?page=wc_pos_settings" id="settings_page"
        ...
        <button class="button ladda-button tips" data-spinner-color="#6d6d6d" id="sync_data"
                data-tip='<span id="last_sync_time"></span>'><span
                    class="ladda-label"></span><?php _e('Sync', 'wc_point_of_sale'); ?></button>
        ...
        <?php } ?>
        <a class="button tips" href="#" id="full_screen" data-tip="<?php _e('Full screen', 'wc_point_of_sale'); ?>"></a>
    </h2>
    <?php
