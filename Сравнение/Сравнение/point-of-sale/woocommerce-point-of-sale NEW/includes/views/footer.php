...
// don't load directly
    ...
    <div class="md-modal md-dynamicmodal <?php echo $full_keypad == 'yes' && $instant_quantity == 'yes' ? 'full_keypad' : ''; ?>"
        ...
        <div class="md-content">
            ...
            <div>
                ...
                <a href="#reset" id="reset_selected_variation"
                   style="float: right;"><?php _e('Reset', 'wc_point_of_sale'); ?></a>
                <div class="clear"></div>
    ...
    <?php if ($instant_quantity == 'yes') { ?>
        <div class="md-modal md-dynamicmodal <?php echo $full_keypad == 'yes' ? 'full_keypad' : ''; ?>"
             id="modal-qt-product">
            <div class="md-content">
