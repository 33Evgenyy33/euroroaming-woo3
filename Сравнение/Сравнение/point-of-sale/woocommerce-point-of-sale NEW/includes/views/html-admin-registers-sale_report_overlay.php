        ...
        <div class="cash-result">
            ...
            <table class="wp-list-table widefat fixed posts">
                ...
                <tr>
                    ...
                    <td class="actual-cash"><?php echo ($data['detail']['actual_cash']) ? wc_price($data['detail']['actual_cash']) : __('Click to set', 'wc_point_of_sale'); ?></td>
                </tr>
                <tr>
            ...
            <div class="cash-popup" id="cash-popup">
                ...
                <?php foreach ($nominals as $nominal) { ?>
                    <div class="nominal-row">
                        <label for="nominal-<?php echo $nominal ?>"><?php echo wc_price($nominal) . ' = ' ?></label>
                        <input type="number" class="nominal" id="nominal-<?php echo $nominal ?>"
                               data-value="<?php echo $nominal ?>">
                    </div>
                <?php } ?>
                <a href="#" class="button alignright"><?php _e('Ok', 'wc_point_of_sale') ?></a>
            </div>
        <?php } ?>
    <?php } ?>
</div>