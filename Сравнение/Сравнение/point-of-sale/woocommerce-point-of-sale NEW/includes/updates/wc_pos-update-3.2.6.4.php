...
global $wpdb;
$wpdb->hide_errors();
if (is_null($wpdb->query("SELECT NULL
    ...
    $result['show_sku'] = $wpdb->query("ALTER TABLE {$wpdb->prefix}wc_poin_of_sale_receipts ADD `print_copies_count` int(11) NOT NULL DEFAULT '1' ");
}
