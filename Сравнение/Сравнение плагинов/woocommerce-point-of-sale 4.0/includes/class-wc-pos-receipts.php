                                        ...
                                        <div class="inside">
                                            <table id="receipt_options">
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_name"><?php _e('Receipt Name', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="show_site_name"><?php _e('Print Shop Name', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="show_outlet"><?php _e('Print Outlet Name', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_outlet_address"><?php _e('Print Outlet Address', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_outlet_contact_details"><?php _e('Print Outlet Contact Details', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_tax_number"><?php _e('Print Tax Number', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_order_time"><?php _e('Print Order Date', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="show_receipt_print_order_time">
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_order_date_format"><?php _e('Date Format', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                        <?php
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_server"><?php _e('Print Server', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr class="show_receipt_print_register_name_served">
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="show_register"><?php _e('Print Register Name', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_show_image_product"><?php _e('Print Product Image', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="show_sku"><?php _e('Print Product SKU', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_number_items"><?php _e('Print Number of Items', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_order_notes"><?php _e('Print Order Notes', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_barcode"><?php _e('Print Order Barcode', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_copies_count"><?php _e('Print Copies Count', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                        <select id="receipt_print_copies_count" name="print_copies_count">
                                        ...
                                        <div class="inside">
                                            <table id="customer_details">
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_customer_name"><?php _e('Print Customer Name', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_customer_email"><?php _e('Print Customer Email', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <label class="receipt_labels"
                                                               for="receipt_print_customer_ship_address"><?php _e('Print Shipping Address', 'wc_point_of_sale'); ?></label>
                                                    </td>
                                                    <td>
                            ...
                            <div id="postbox-container-1" class="postbox-container">
                                <div class="meta-box-sortables">
                                    <div class="postbox ">
                                        ...
                                        <div class="inside">
                                            <p class="hide-if-no-js">
                                                ...
                                                <a class="set_receipt_logo" id="set_receipt_logo_img" href="#"
                                                   title="<?php _e('Set Receipt Logo', 'wc_point_of_sale'); ?>" <?php echo $receipt_logo_style; ?> >
                                                ...
                                                <a class="remove_receipt_logo" href="#"
                                                   title="<?php _e('Remove Receipt Logo', 'wc_point_of_sale'); ?>" <?php echo $receipt_logo_style; ?> >
                                                    <?php _e('Remove Receipt Logo', 'wc_point_of_sale'); ?>
                                                </a>
                                                <a class="set_receipt_logo" id="set_receipt_logo_text" href="#"
                                                   title="<?php _e('Set Receipt Logo', 'wc_point_of_sale'); ?>" <?php echo ($receipt_options['logo']) ? 'style="display: none;"' : ''; ?> >
                                    ...
                                    <div class="postbox ">
                                        ...
                                        <h3 class="hndle">
                                            <label class="receipt_labels"
                                                   for="receipt_logo"><?php _e('Preview', 'wc_point_of_sale'); ?></label>
