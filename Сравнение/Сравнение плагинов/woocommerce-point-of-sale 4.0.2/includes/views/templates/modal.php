                ...
                {{#case "checkbox" break=true}}
                    {{#each options}}
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" data-raw-price="{{price}}" data-price="{{price}}" class="addon addon-checkbox {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" name="{{../type}}_{{@../index}}">
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "radiobutton" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}{{{accountingPOS price}}}</td>
                            <td>
                                <input type="radio" data-raw-price="{{price}}" data-price="{{price}}" class="addon addon-radio {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" name="{{../type}}_{{@../index}}">
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_textarea" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}{{{accountingPOS price}}}</td>
                            <td>
                                <textarea data-raw-price="{{price}}" data-price="{{price}}" class="input-text addon addon-custom-textarea {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_maxlength}}></textarea>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" class="input-text addon addon-custom {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_maxlength}}>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_email" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="email" data-raw-price="{{price}}" data-price="{{price}}" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" class="input-text addon addon-custom addon-custom-email {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}">
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_price" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="number" step="any" data-raw-price="{{price}}" class="input-text addon addon-custom-price {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_max}} {{product_addons_min}}>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_letters_only" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[A-Za-z]*" class="input-text addon addon-custom addon-custom-pattern {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_maxlength}}>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_digits_only" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[0-9]*" class="input-text addon addon-custom addon-custom-pattern {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_maxlength}}>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "custom_letters_or_digits" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}</td>
                            <td>
                                <input type="text" data-raw-price="{{price}}" data-price="{{price}}" pattern="[A-Za-z0-9]*" class="input-text addon addon-custom addon-custom-pattern {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_maxlength}}>
                            </td>
                        </tr>
                    {{/each}}
                {{/case}}
                {{#case "input_multiplier" break=true}}
                    {{#each options}}
                        <tr>
                            <td>{{label}}{{{accountingPOS price}}}</td>
                            <td>
                                <input type="number" step="any" data-raw-price="{{price}}" data-price="{{price}}" class="input-text addon addon-input_multiplier {{../type}}_{{@../index}} {{../type}}_{{@../index}}_{{@index}}" {{product_addons_max}} {{product_addons_min}}>
                    ...
                    <tr>
                        <td colspan="2">
                            <select class="addon addon-select {{type}}_{{@index}}">
                                <option value=""><?php _e('Choose an option...', 'wc_point_of_sale'); ?></option>
                                {{#each options}}
                                <option data-raw-price="{{price}}" data-price="{{price}}" value="{{label}}">{{label}}{{{accountingPOS price}}}</option>
                                {{/each}}
                            </select>
                        </td>
                    </tr>                    
...
<script type="text/template" id="tmpl-product-addons-total">
    <li class="clearfix" id="product-addons-total" data-show-grand-total="1" data-tax-mode="<?php echo esc_attr( $tax_mode ); ?>" data-tax-display-mode="<?php echo esc_attr( $tax_display_mode ); ?>" >
    </li>
</script>
        ...
        <div class="woocommerce-shipping-fields">
            <div class="shipping_address">
                <p class="billing-same-as-shipping">
                    <a id="billing-same-as-shipping" class="button billing-same-as-shipping"><?php _e('Copy billing address', 'wc_point_of_sale'); ?></a>
                </p>
                <?php
