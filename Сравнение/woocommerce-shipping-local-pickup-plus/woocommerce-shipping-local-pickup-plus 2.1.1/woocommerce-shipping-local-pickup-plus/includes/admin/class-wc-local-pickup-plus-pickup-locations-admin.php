...
class WC_Local_Pickup_Plus_Pickup_Locations_Admin {
	...
	public function customize_row_actions( $actions, $post ) {
		...
		if ( current_user_can( 'delete_post', $post->ID ) ) {
			$actions['delete'] = "<a class='submitdelete delete-pickup-location' title='" . esc_attr__( 'Delete this pickup location permanently', 'woocommerce-memberships' ) . "' href='" . esc_url( get_delete_post_link( $post->ID, '', true ) ) . "'>" . esc_html__( 'Delete', 'woocommerce-shipping-local-pickup-plus' ) . "</a>";
		}
