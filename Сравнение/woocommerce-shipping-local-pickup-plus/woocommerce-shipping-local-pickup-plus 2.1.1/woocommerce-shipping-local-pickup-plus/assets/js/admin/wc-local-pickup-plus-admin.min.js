(function() {  "use strict";
  ...
  jQuery(document).ready(function($) {
    var $apiKeyField, $appointmentsMode, $defaultOpt, $distanceOpt, $form, $goBack, $header, $locationSortOrder, $loggingField, $loggingInput, $pickupDataField, $pickupDateCalendars, $searchPickupLocations, $sortingDesc, getEnhancedSelectFormatString, pagenow, ref, ref1, wc_local_pickup_plus_admin;
    ...
    if ('woocommerce_page_wc-settings' === pagenow) {
      ...
      if ($locationSortOrder) {
        $locationSortOrder.on('change', function(e) {
          var $searchRadius;
          $searchRadius = $('#woocommerce_local_pickup_plus_search_radius').closest('td').parent();
          if ($(this).val() === !'distance_customer') {
            return $searchRadius.hide();
          } else {
            return $searchRadius.show();
          }
        });
